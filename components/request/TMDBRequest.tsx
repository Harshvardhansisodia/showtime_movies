  ...
  return (
    <section className="px-3 py-10">
      <div className="flex items-center gap-2">
        ...
        <div className="inline-flex rounded-md bg-white/10 p-1 border border-white/10">
          <button
            type="button"
            onClick={() => setKind("movie")}
            className={`px-3 h-10 rounded ${kind === "movie" ? "bg-white text-black" : "text-gray-200 hover:text-white"}`}
          ...
          <button
            type="button"
            onClick={() => setKind("tv")}
            className={`px-3 h-10 rounded ${kind === "tv" ? "bg-white text-black" : "text-gray-200 hover:text-white"}`}
        ...
        <button
          ...
          className={`h-10 rounded-md px-4 flex items-center justify-center gap-2 
    ${loading || !q.trim()
